...
INSERT INTO "new_OrgSettings" ("approvalAuthorityHighLabel", "approvalAuthorityLowLabel", "approvalThreshold", "id", "logoUrl", "orgName", "primaryColor", "reassessmentCadenceDays", "updatedAt") SELECT "approvalAuthorityHighLabel", "approvalAuthorityLowLabel", "approvalThreshold", "id", "logoUrl", "orgName", "primaryColor", "reassessmentCadenceDays", "updatedAt" FROM "OrgSettings";
